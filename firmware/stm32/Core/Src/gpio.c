...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PB3 PB8 PB9 PB1
                           PB0 PB11 PB10 PB2 */
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_1
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_1|MOTOR_EN_Pin;
